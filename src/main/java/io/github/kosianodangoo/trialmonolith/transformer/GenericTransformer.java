...
public class GenericTransformer {
    ...
    public static int transform(Phase phase, ClassNode classNode) {
        ...
        return !modified ? ILaunchPluginService.ComputeFlags.NO_REWRITE : (needsFrames ? ILaunchPluginService.ComputeFlags.COMPUTE_FRAMES : ILaunchPluginService.ComputeFlags.SIMPLE_REWRITE);
    }
